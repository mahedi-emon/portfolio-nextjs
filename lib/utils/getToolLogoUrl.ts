...
const toolLogoOverrides: Record<string, string> = {
  ...
  sqlserver: `${LOGO_BASE_URL}mysql`,
  mssql: `${LOGO_BASE_URL}mysql`,
  microsoftsqlserver: `${LOGO_BASE_URL}mysql`,
  oracle: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/oracle/oracle-original.svg",
  oracledatabase: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/oracle/oracle-original.svg",
  ...
  databasedesign: `${LOGO_BASE_URL}postgresql`,
  ...
  portainer: `${LOGO_BASE_URL}portainer`,
  ...
  appliedaiengineer: AI_LOGO,
  artificialintelligence: AI_LOGO,
  artificialintelligenceai: AI_LOGO,
  ai: AI_LOGO,
  explainableai: `${LOGO_BASE_URL}python`,
  xai: `${LOGO_BASE_URL}python`,
  explainableaixaishap: `${LOGO_BASE_URL}python`,
  shap: `${LOGO_BASE_URL}python`,
  machinelearning: `${LOGO_BASE_URL}tensorflow`,
  deeplearning: `${LOGO_BASE_URL}keras`,
  ...
  webdevelopment: WEB_LOGO,
  softwareengineering: `${LOGO_BASE_URL}codeigniter`,
  research: `${LOGO_BASE_URL}googlescholar`,
...
const slugifySimpleIcon = (name: string): string =>
  normalizeForLookup(name).replace(/[^a-z0-9]/g, "");

export const getToolLogoUrl = (name: string): string => {
