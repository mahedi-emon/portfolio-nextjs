...
function personSchema(about?: About, hero?: Hero, socialUrls?: string[]) {
  ...
  return {
    ...
    jobTitle: about?.currentRole || "Full-Stack Developer & ML Engineer",
    description:
      about?.tagline ||
      hero?.subheadline ||
      "Full-Stack Developer & ML Engineer specializing in scalable web platforms — React, Next.js, Django, Python, and applied Machine Learning / Deep Learning / NLP. Computer Science Engineering graduate from Daffodil International University, Bangladesh.",
    ...
    knowsLanguage: ["English", "Bengali", "Bangla"],
    knowsAbout: [
      // Web dev
      "Web Development",
    ...
    hasOccupation: [
      {
        ...
        skills: "React, Next.js, TypeScript, Django, Python, Node.js, PostgreSQL, Supabase",
      },
      {
        "@type": "Occupation",
        name: "Machine Learning Engineer",
        skills: "Machine Learning, Deep Learning, NLP, PyTorch, TensorFlow, Hugging Face, BanglaBERT",
      },
    ],
    sameAs: socialUrls ?? [],
  };
